...
/*
Solution by the lector
* */

public class o5_BreakCyclesSolution2 {
  ...
  private static boolean searchForCycles(
      String node, Set<String> visited, SortedSet<String> cycle, String parent) {
